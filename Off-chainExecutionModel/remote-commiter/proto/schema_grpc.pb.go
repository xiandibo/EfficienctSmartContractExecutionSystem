...
type CommitClient interface {
	...
	CallSmartContract(ctx context.Context, in *InputForSC, opts ...grpc.CallOption) (*ResultFromEVM, error)
	CallSmartContractInFollower(ctx context.Context, in *InputForSC, opts ...grpc.CallOption) (*ResultFromEVM, error)
	SC2PCPropose(ctx context.Context, in *ProposeReqForSC, opts ...grpc.CallOption) (*ResponseFromFollower, error)
	SC2PCCommit(ctx context.Context, in *CommitReqForSC, opts ...grpc.CallOption) (*ResponseFromFollower, error)
	SendTx(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *commitClient) CallSmartContract(ctx context.Context, in *InputForSC, opts ...grpc.CallOption) (*ResultFromEVM, error) {
	out := new(ResultFromEVM)
	err := c.cc.Invoke(ctx, "/schema.Commit/CallSmartContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitClient) CallSmartContractInFollower(ctx context.Context, in *InputForSC, opts ...grpc.CallOption) (*ResultFromEVM, error) {
	out := new(ResultFromEVM)
	err := c.cc.Invoke(ctx, "/schema.Commit/CallSmartContractInFollower", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitClient) SC2PCPropose(ctx context.Context, in *ProposeReqForSC, opts ...grpc.CallOption) (*ResponseFromFollower, error) {
	out := new(ResponseFromFollower)
	err := c.cc.Invoke(ctx, "/schema.Commit/SC2PCPropose", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitClient) SC2PCCommit(ctx context.Context, in *CommitReqForSC, opts ...grpc.CallOption) (*ResponseFromFollower, error) {
	out := new(ResponseFromFollower)
	err := c.cc.Invoke(ctx, "/schema.Commit/SC2PCCommit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commitClient) SendTx(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/schema.Commit/SendTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommitServer interface {
	...
	//2pc for smart contract interface
	CallSmartContract(context.Context, *InputForSC) (*ResultFromEVM, error)
	CallSmartContractInFollower(context.Context, *InputForSC) (*ResultFromEVM, error)
	SC2PCPropose(context.Context, *ProposeReqForSC) (*ResponseFromFollower, error)
	SC2PCCommit(context.Context, *CommitReqForSC) (*ResponseFromFollower, error)
	SendTx(context.Context, *Transaction) (*Response, error)
...
func (UnimplementedCommitServer) CallSmartContract(context.Context, *InputForSC) (*ResultFromEVM, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CallSmartContract not implemented")
}
func (UnimplementedCommitServer) CallSmartContractInFollower(context.Context, *InputForSC) (*ResultFromEVM, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CallSmartContractInFollower not implemented")
}
func (UnimplementedCommitServer) SC2PCPropose(context.Context, *ProposeReqForSC) (*ResponseFromFollower, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SC2PCPropose not implemented")
}
func (UnimplementedCommitServer) SC2PCCommit(context.Context, *CommitReqForSC) (*ResponseFromFollower, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SC2PCCommit not implemented")
}
func (UnimplementedCommitServer) SendTx(context.Context, *Transaction) (*Response, error) {
...
func _Commit_CallSmartContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InputForSC)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServer).CallSmartContract(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.Commit/CallSmartContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServer).CallSmartContract(ctx, req.(*InputForSC))
	}
	return interceptor(ctx, in, info, handler)
}

func _Commit_CallSmartContractInFollower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InputForSC)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServer).CallSmartContractInFollower(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.Commit/CallSmartContractInFollower",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServer).CallSmartContractInFollower(ctx, req.(*InputForSC))
	}
	return interceptor(ctx, in, info, handler)
}

func _Commit_SC2PCPropose_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProposeReqForSC)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServer).SC2PCPropose(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.Commit/SC2PCPropose",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServer).SC2PCPropose(ctx, req.(*ProposeReqForSC))
	}
	return interceptor(ctx, in, info, handler)
}

func _Commit_SC2PCCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CommitReqForSC)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServer).SC2PCCommit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.Commit/SC2PCCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServer).SC2PCCommit(ctx, req.(*CommitReqForSC))
	}
	return interceptor(ctx, in, info, handler)
}

func _Commit_SendTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Transaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommitServer).SendTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/schema.Commit/SendTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommitServer).SendTx(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Commit_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Commit_CallSmartContract_Handler,
		},
		{
			MethodName: "CallSmartContractInFollower",
			Handler:    _Commit_CallSmartContractInFollower_Handler,
		},
		{
			MethodName: "SC2PCPropose",
			Handler:    _Commit_SC2PCPropose_Handler,
		},
		{
			MethodName: "SC2PCCommit",
			Handler:    _Commit_SC2PCCommit_Handler,
		},
		{
			MethodName: "SendTx",
			Handler:    _Commit_SendTx_Handler,
		},
	},
